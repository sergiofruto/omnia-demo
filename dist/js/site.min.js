"use strict";!function(e){e(function(){e(".button-collapse").sideNav(),e("select").material_select(),e(".modal-trigger").leanModal(),e(".toggle-show").click(function(){e("#prob_more_info").toggleClass("hide")})})}(jQuery);
